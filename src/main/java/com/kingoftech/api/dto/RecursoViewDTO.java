...
public class RecursoViewDTO {
	...
	public String toString() {
		return "RecursoViewDTO [id=" + id + ", createdBy=" + createdBy + ", updatedBy=" + updatedBy + ", updatedDate="
				+ updatedDate + ", createdDate=" + createdDate + ", nome=" + nome + ", ativo=" + ativo + ", projeto="
				+ projeto + "]";
	}
