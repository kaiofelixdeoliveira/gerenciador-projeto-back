...
public class ProjetosCreateDTO {

	private String codigo;
	private String proposta;
	@NotEmpty(message = "Preenchimento da desccricao é obrigatorio")
	private String descricao;
	@NotNull(message = "Preenchimento da quantidade de horas é obrigatorio")
	...
	public String toString() {
		return "ProjetosCreateDTO [codigo=" + codigo + ", proposta=" + proposta + ", descricao=" + descricao
